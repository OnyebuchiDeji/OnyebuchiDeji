...
+  Results-driven aspiring software developer and data scientist: fullstack, desktop, AI, datascience, and graphics.
+  Versatile in range of expertise, always eager to learn and adaptable to a wide variety of work environments. 
+  Exploring the math behind custom AI applications and in 2D/3D graphics whilst maintaining web development and software engineering skills.
+  Core Languages: Python, C++, JavaScript (React & Vanilla), HTML & CSS, Java, and PHP.
+  Consistently utilise AGILE methods in software development.
...
# 📊 GitHub Stats:
![](https://github-readme-stats.vercel.app/api?username=OnyebuchiDeji&theme=moltack&hide_border=false&include_all_commits=false&count_private=false)<br/>
